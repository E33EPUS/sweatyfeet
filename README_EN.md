...
2. Drop it into the modpack's `.minecraft/mods/` (e.g. 1.21.1-CCB)
...
- Repo: `github.com/E33EPUS/sweatyfeet`, `Fabric-1.21.1` branch (ported from the NeoForge version, Yarn mappings)
